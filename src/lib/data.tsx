...
export const COURCES: CourceDetails[] = [
  {
    ...
    institution: "Udemy (Eazy Bytes)",
    duration: "40 hours",
    progress: Math.round((130 / 282) * 100),
    skills: [
      "Spring Cloud",
      "Docker",
      "Kubernetes",
  ...
  },
  {
    ...
    institution: "Udemy (Mahmoud Youssef)",
    duration: "11 hour",
    progress: Math.round((8 / 216) * 100),
  ...
  },
  {
    ...
    institution: "Udemy (Hussein Nasser)",
    duration: "17 Hour 22 Minute",
    progress: Math.round((0 / 58) * 100),
    skills: [
  ...
  },
  {
    ...
    institution: "Udemy (Michael Pogrebinsky)",
    duration: "7 Hour",
    progress: Math.round((0 / 45) * 100),
    skills: [
  ...
  {
    id: "spring-security",
    name: "Spring Security 6 Zero to Master along with JWT,OAUTH2",
    institution: "Udemy (Eazy Bytes)",
    duration: "25 Hour",
    progress: 100,
    skills: [
  ...
  },
  {
    ...
    institution: "Udemy (Hassan Fulaih)",
    duration: "12 Hour",
    progress: 100,
    skills: ["Basics Dart"],
    status: "completed",
